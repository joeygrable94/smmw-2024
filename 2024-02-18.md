...
- [Google Natural Language API](cloud.google.com/natrual-language) to see all the related entities in a block of text and how Google parses keyword entities
